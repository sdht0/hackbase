...
(3, 3, 'level3', 'Preliminary information says IP of one of the hidden servers is [IP_TRIPLET].xxx. You need to find out the last octet.', 'Apply 5xN to ______', 'Cipher=[CIPHER]', '[IP_SERVER1]', 10, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
(6, 6, 'level6', 'This seems to be a dummy server. Find the last octet of the next hidden server.', '', '', '[IP_SERVER2]', 10, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
